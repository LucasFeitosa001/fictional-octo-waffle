...
(async () => {
  ...
  try {
    await p.goto('https://belasis.app/clients', { waitUntil: 'networkidle', timeout: 45000 });
    ...
    fs.writeFileSync('/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/clientes.html', html);
    await p.screenshot({ path: '/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/clientes.png', fullPage: true });
    ...
    fs.writeFileSync('/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/clientes.info.json', JSON.stringify(info, null, 2));
    console.log('OK clientes', fs.statSync('/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/clientes.html').size);
