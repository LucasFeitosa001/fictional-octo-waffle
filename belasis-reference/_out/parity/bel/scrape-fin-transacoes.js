...
(async () => {
  ...
  try {
    await p.goto('https://belasis.app/finance/transactions', { waitUntil: 'networkidle', timeout: 45000 });
    ...
    fs.writeFileSync('/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/fin-transacoes.html', html);
    await p.screenshot({ path: '/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/fin-transacoes.png', fullPage: true });
    ...
    fs.writeFileSync('/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/fin-transacoes.info.json', JSON.stringify(info, null, 2));
    console.log('OK fin-transacoes', fs.statSync('/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/fin-transacoes.html').size);
