...
(async () => {
  ...
  try {
    await p.goto('https://belasis.app/suppliers', { waitUntil: 'networkidle', timeout: 45000 });
    ...
    fs.writeFileSync('/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/fornecedores.html', html);
    await p.screenshot({ path: '/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/fornecedores.png', fullPage: true });
    ...
    fs.writeFileSync('/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/fornecedores.info.json', JSON.stringify(info, null, 2));
    console.log('OK fornecedores', fs.statSync('/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/fornecedores.html').size);
