...
(async () => {
  ...
  try {
    await p.goto('https://belasis.app/finance/payment-methods', { waitUntil: 'networkidle', timeout: 45000 });
    ...
    fs.writeFileSync('/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/fin-formas.html', html);
    await p.screenshot({ path: '/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/fin-formas.png', fullPage: true });
    ...
    fs.writeFileSync('/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/fin-formas.info.json', JSON.stringify(info, null, 2));
    console.log('OK fin-formas', fs.statSync('/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/fin-formas.html').size);
