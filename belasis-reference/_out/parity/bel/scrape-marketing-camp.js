...
(async () => {
  ...
  try {
    await p.goto('https://belasis.app/marketing/campaigns', { waitUntil: 'networkidle', timeout: 45000 });
    ...
    fs.writeFileSync('/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/marketing-camp.html', html);
    await p.screenshot({ path: '/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/marketing-camp.png', fullPage: true });
    ...
    fs.writeFileSync('/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/marketing-camp.info.json', JSON.stringify(info, null, 2));
    console.log('OK marketing-camp', fs.statSync('/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/bel/marketing-camp.html').size);
