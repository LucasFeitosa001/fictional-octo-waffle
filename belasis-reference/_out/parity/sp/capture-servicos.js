...
(async () => {
  ...
  try {
    ...
    await p.goto('https://conferences-collar-proof-mine.trycloudflare.com/servicos', { waitUntil: 'networkidle', timeout: 30000 });
    for (let i=0;i<3;i++) { await p.evaluate(y => window.scrollTo(0,y), i*400); await new Promise(r=>setTimeout(r,500)); }
    await new Promise(r=>setTimeout(r,2000));
    await p.screenshot({ path: '/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/sp/servicos.png', fullPage: true });
    ...
    fs.writeFileSync('/home/lucssfeitosa/beautypass/beautypass/belasis-reference/_out/parity/sp/servicos.info.json', JSON.stringify(info, null, 2));
    console.log('OK servicos', p.url());
