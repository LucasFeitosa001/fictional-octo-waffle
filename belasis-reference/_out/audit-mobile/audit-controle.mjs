...
const ROUTES = ["/controle/compras","/controle/pacotes-predefinidos"];
...
try {
  ...
  await page.fill('input[type=email]', 'contato@fatimacabelos.com.br');
...
console.log(JSON.stringify({ group: 'Controle', pages: results }, null, 2));
await browser.close();
