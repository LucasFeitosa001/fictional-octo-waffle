...
const ROUTES = ["/marketing/campanhas","/marketing/cashback","/marketing/avaliacoes","/marketing/promocoes"];
...
console.log(JSON.stringify({ group: 'Marketing', pages: results }, null, 2));
await browser.close();
