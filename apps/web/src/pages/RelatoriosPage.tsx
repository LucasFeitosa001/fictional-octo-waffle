...
const CATEGORIES: Category[] = [
  ...
  {
    slug: 'financeiro',
    to: '/reports/financial/dre',
    title: 'Financeiro (DRE)',
    description: 'Receitas e despesas por categoria, resultado, fluxo de caixa e extratos',
    icon: <IconDollar size={20} />,
  },
  {
    slug: 'agendamentos',
    to: '/reports/calendars/all',
    title: 'Agendamentos',
  ...
  },
  {
    ...
    title: 'Estoque',
    description: 'Estoque atual, lista de produtos e serviços e sugestão de compra',
  ...
  },
  {
    ...
    to: '/reports/invoices',
    title: 'Notas Fiscais',
    description: 'Notas fiscais emitidas (NFS-e, NF-e, NFC-e)',
