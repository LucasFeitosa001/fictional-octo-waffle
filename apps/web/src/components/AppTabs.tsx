...
export function AppTabs<Key extends string>({
  ...
  // (2) sem snap, a rolagem parava no meio de um item. Ver .claude/studies/12.
  ...
  return (
    ...
    >
      <Tabs.ListContainer
        ref={containerRef}
        className="max-w-full snap-x snap-mandatory overflow-x-auto overscroll-x-contain scroll-smooth rounded-xl border border-line bg-card p-1 shadow-[var(--shadow-soft)] scrollbar-none"
      >
        <Tabs.List
