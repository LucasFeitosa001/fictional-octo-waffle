  ...
  return (
    <>
      ...
      <nav
        ...
        // Barra FLUTUANTE: afastada da borda inferior segura. No Safari (com URL
        // bar) a inset é 0 → cai no piso de 0.75rem (respiro normal). Em
        // standalone a inset (~34px do home indicator) soma +0.5rem de respiro,
        // deixando a barra logo ACIMA do home indicator, sem "subir" demais nem
        // encostar nele. O padding interno vem só do py-2 dos botões (o
        // padding-bottom duplicado da .club-bottomnav foi removido no CSS).
        className="sp-navbar-surface club-bottomnav fixed inset-x-3 bottom-[max(0.75rem,calc(env(safe-area-inset-bottom)+0.5rem))] z-40 mx-auto max-w-lg rounded-[24px] border border-white/10 shadow-[0_18px_55px_rgba(0,0,0,0.32)] lg:hidden"
      >
        {contextual ? (
